...
extern bool wallet_create(const char* seed, bool is_ivk, const char* chain_id, const char* protocol_contract, const char* vault_contract, const char* alias_authority, wallet_t*& p_wallet);
...
extern const char* wallet_vault_contract(wallet_t* p_wallet);
...
extern uint64_t wallet_auth_count(wallet_t* p_wallet);
extern uint64_t wallet_set_auth_count(wallet_t* p_wallet, uint64_t count);
...
extern const char* wallet_create_unpublished_auth_note(wallet_t* p_wallet, const char* seed, uint64_t contract, const char* address);
